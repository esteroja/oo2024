...
public class RestTemplateController {
    ...
    public List<Post> getPosts(){
        ...
        // 1. aadress kuhu 2. meetod mida teeme( alati meil GET)
        // 3. mida kaasa saada (Body, headerid) 4. mis objekti kujuna saame andmed
        ResponseEntity<Post[]> response = restTemplate.exchange(url, HttpMethod.GET, null, Post[].class); //päringut tegemine teisest backendist
